...
template <class T, class U>
void sort_by_first(std::vector<Pair<T, U>> &v) {
    std::sort(v.begin(), v.end(), [](const Pair<T, U> &a, const Pair<T, U> &b) -> bool {
        return a.get_first() < b.get_first();
    });
}

template <class T, class U>
void sort_by_second(std::vector<Pair<T, U>> &v) {
    std::sort(v.begin(), v.end(), [](const Pair<T, U> &a, const Pair<T, U> &b) -> bool {
...
template <class T, class U>
void show(const std::vector<Pair<T, U>> &v) {
    std::cout << "{";
