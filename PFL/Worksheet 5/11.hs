...
satisfies :: Prop -> [Env]
satisfies p = [env | env <- environments (vars p), eval env p]

-- >>> satisfies (And (Not (Var 'a')) (Var 'b'))
-- >>> satisfies (Or (And (Not (Var 'a')) (Var 'b')) (Var 'c'))
-- [[('a',False),('b',True)]]
-- [[('a',False),('b',False),('c',True)],[('a',False),('b',True),('c',False)],[('a',False),('b',True),('c',True)],[('a',True),('b',False),('c',True)],[('a',True),('b',True),('c',True)]]
